...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="../css/perfil.password.css">
      ...
      ?>
       ...
       <li class="perfil__item" id="perfil__item">
        ...
        <ul class="menu2" id="menu2">
          <li class="menu__item2"><a class="menu__link2" id="menu__link2-perfil" href="perfil.controller.php?id=<?php echo $user['id']; ?>&avatar=<?php echo $user['avatar']; ?>&name=<?php echo $user['name']; ?>&sex=<?php echo $user['sex']; ?>&user=<?php echo $user['user']; ?>&mail=<?php echo $user['mail']; ?>"><span class="icon-user"></span> Perfil</a></li>
