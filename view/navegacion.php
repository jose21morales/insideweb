...
<head>
  ...
  <meta name="description" content="Hola si tienes una pequeña o mediana empresa y quieres aumentar tus ventas por internet llegando a más personas esta es tu oportunidad, en InsideWEB desarrollamos tu proyecto.">
  <meta name="keywords" content="desarrollo web, diseño web, marketing digital, programacion, paginas web, creacion de paginas web, desarrollo web en cacahoatan, diseño web en cacahoatan, diseño web en tapachula, desarrollo web en tapachula">
	<title>Desarrollo web en cacahotan</title>
	<link rel="stylesheet" type="text/css" href="css/styles.css">
  <link rel="stylesheet" type="text/css" href="css/estilos.css">
  <link rel="stylesheet" type="text/css" href="css/register.css">
  <link rel="stylesheet" type="text/css" href="css/contact.css">
  <link rel="stylesheet" type="text/css" href="css/blogs.css">
  <link rel="stylesheet" type="text/css" href="css/blog-view.css">
...
<div class="contenedor-div--flex-2">
      ...
      ?>
       ...
       <li class="menu__item"><a class="menu__link select" id="menu__link-home" href="index.php"><span class="icon-home"></span> Inicio</a></li>
		 </ul>
		</div>
     ...
     <ul class="menu" id="menu">
      ...
      ?>
       ...
       <li class="menu__item"><a class="menu__link
        ...
        " id="menu__link-about" href="index.php?action=about"><span class="icon-user"></span> Acerca de..</a></li>
       ...
       <li class="menu__item"><a class="menu__link
        ...
        " id="menu__link-blog" href="index.php?action=blog"><span class="icon-social-blogger"></span> Blog</a></li>
       ...
       <li class="menu__item"><a class="menu__link
        ...
        " id="menu__link-portafolio" href="index.php?action=projects"><span class="icon-folder-open"></span> Proyectos</a></li>
       ...
       <li class="menu__item"><a class="menu__link
        ...
        " id="menu__link-contact" href="index.php?action=contact"><span class="icon-phone"></span> Contacto</a></li>
